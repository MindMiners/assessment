...
testData.SeFi = {
  name: 'SeFi',
  option: 'I am sensitive to other people\'s feelings and often hear that I\'m a really good listener. It\'s a goal of mine that everyone who walks away from a conversation with me feels valued, like I cared about them and what they had to say. I generally need some time alone to process my feelings about things. If I\'m in a new situation that is uncomfortable and I have negative feelings about it, my default response is usually just to get through it however I can. Once I\'m home or away from the situation I can start to process those feelings and understand exactly what was going on. From there I can figure out what I would do if something similar happened again, and the next time I\'m able to just rely on that default response. I also have a thirst for efficiency and don\'t like for things to be overly complicated. I sometimes spend time thinking about ways to reduce things down to as few steps as possible.',
  // parent: testData.Se,
  finalType: 'SeFi',
};
...
testData.F = {
  name: 'F',
  option: 'I have a very high value for people and have strong personal beliefs. I feel like I\'m really good at understanding people and their feelings. For me to feel good making a decision, it needs to be aligned with who I am and what I believe in. I get frustrated when people are overly critical/judgmental of others or when they put “logic” over the actual impact a decision will have on people.',
  question: 'Which of these sounds most like you?',
...
testData.TeNi = {
  name: 'TeNi',
  option: 'I am an abstract thinker and have a high value for innovation. For the most part, I like to come up with novel ways of doing things. I trust my intuition quite a bit and can usually skip ten steps ahead in predicting how a situation will play out. It\'s easy for me to see multiple perspectives in an argument, and to highlight the points of view that aren\'t being expressed.i',
  // parent: testData.Te,
  finalType: 'TeNi',
};
